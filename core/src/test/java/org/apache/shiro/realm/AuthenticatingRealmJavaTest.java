...
public class AuthenticatingRealmJavaTest {
    ...
    @Test
    public void authenticatingRealmShouldCreateArgonHashWhenUserDoesNotExist() {
        // given
        ...
        // when
        AuthenticationInfo info = spiedRealm.getAuthenticationInfo(token);
        ...
        assertThat(simulatedCredentials).isInstanceOf(SimpleHash.class);
    }

    @Test
    public void authenticatingRealmShouldCreateBcryptHashWhenUserDoesNotExist() {
        // given
        DefaultHashService bcraptHashService = new DefaultHashService();
        // bcraptHashService.setDefaultAlgorithmName("2y");
        bcraptHashService.setHashAlgorithmName("SHA-256");
    ...
    static class NullAuthenticatingRealm extends AuthenticatingRealm {
        ...
        AuthenticationInfo ensureSimulatedAuthenticationInfo() {
            final AuthenticationInfo authInfo1 = super.ensureSimulatedAuthenticationInfo();
